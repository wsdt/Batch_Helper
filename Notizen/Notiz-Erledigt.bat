...
echo.
color a
echo Bitte waehle die Notiz-Registernummer:
set /p noteregister=
ren "%cd%\note%noteregister%.bat" "note%noteregister%e.bat"
echo echo !! Notiz %noteregister% ERLEDIGT !! >> "%cd%\note%noteregister%e.bat"
:end